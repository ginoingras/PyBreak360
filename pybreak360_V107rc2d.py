...
try:
	...
	import pybreak360_balls as balls
...
def main():
	...
	varglob.rayon = varglob.fenetre_center[1] - varglob.playersbat[0][3][1] # remove bat size sprite
	...
	#rand = ((0.1 * (random.randint(5,8))))
	th_E = 0 # server isn't started yet
	ball1 = balls.Ball((50, 50), (ang, speed), th_E, 0, 1, 1) #((px,py),(angle,speed), threadEmission, idx_ball, imgball, status-porteur)
	ball2 = balls.Ball((40, 70), (0.88, 0), th_E, 1, 2, 2)
	ball3 = balls.Ball((700, 700), (4.76, 0), th_E, 2, 3, 3)
	ball4 = balls.Ball((700, 700), (2.76, 0), th_E, 3, 4, 4)
